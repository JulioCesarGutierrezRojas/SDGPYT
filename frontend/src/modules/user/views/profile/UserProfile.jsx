...
import { getUserById, updateUser } from "../../../admin/adapters/user.controller";
...
const MyUserProfile = () => {
    ...
    const handleSaveField = () => {
        ...
        // Para contraseña, no actualizar si está vacía
    ...
    const handleSaveChanges = async () => {
        ...
        try {
            ...
            if (user.contraseña && user.contraseña.trim() !== '') {
                ...
                updateData.password = 'temp'; // Backend ignorará si es temp
            }
